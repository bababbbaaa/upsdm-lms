                        ...
                        <div class="search-input bg-white p-10 flex-grow-1">
                            <form action="<?php echo e((!empty($isRewardProducts) and $isRewardProducts) ? '/reward-products' : '/products'); ?>" method="get">
                                <div class="form-group d-flex align-items-center m-0">
                                    <input type="text" name="search" class="form-control border-0" placeholder="<?php echo e(trans('update.products_search_placeholder')); ?>"/>
...
<?php echo $__env->make('web.default.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/products/search.blade.php ENDPATH**/ ?>