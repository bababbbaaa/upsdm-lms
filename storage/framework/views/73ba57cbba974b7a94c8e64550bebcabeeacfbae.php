                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-7 mt-20 mt-lg-0 text-center">
                        ...
                        <?php if(!empty($rewardsSettings) and !empty($rewardsSettings['exchangeable']) and $rewardsSettings['exchangeable'] == '1'): ?>
                            ...
                            <span class="font-30 font-weight-bold mt-15 text-primary d-block"><?php echo e(addCurrencyToPrice($earnByExchange)); ?></span>
...
<?php echo $__env->make('web.default.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/panel/rewards/index.blade.php ENDPATH**/ ?>