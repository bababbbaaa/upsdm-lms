        ...
        <div class="col-12 col-md-6">
            <form action="/admin/settings/main" method="post">
                ...
                <div class="form-group custom-switches-stacked">
                    ...
                    <div class="text-muted text-small mt-1"><?php echo e(trans('admin/main.active_referral_hint')); ?></div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/settings/financial/referral.blade.php ENDPATH**/ ?>