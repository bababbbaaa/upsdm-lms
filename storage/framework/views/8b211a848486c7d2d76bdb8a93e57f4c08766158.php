<?php $__env->startSection('content'); ?>
    <section class="cart-banner position-relative text-center">
        ...
        <span class="payment-hint font-20 text-white d-block"> <?php echo e(addCurrencyToPrice(handlePriceFormat($subTotal)) . ' ' . trans('cart.for_items',['count' => $carts->count()])); ?></span>
    </section>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/cart/cart.blade.php ENDPATH**/ ?>