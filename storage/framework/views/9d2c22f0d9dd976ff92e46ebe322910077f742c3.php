                    ...
                    <div class="card">
                        <div class="card-body">
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_create_trending_categories')): ?>
                                <a href="/admin/categories/trends/create" class="text-right btn btn-sm btn-success mb-3"><?php echo e(trans('admin/main.create_trend_category')); ?></a>
                            <?php endif; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_edit_trending_categories')): ?>
                                                    <a href="/admin/categories/trends/<?php echo e($trend->id); ?>/edit" class="btn-transparent btn-sm text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_delete_trending_categories')): ?>
                                              <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/categories/trends/'.$trend->id.'/delete','btnClass' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/categories/trends_lists.blade.php ENDPATH**/ ?>