    ...
    <?php if(!empty($user)): ?>
        <div class="text-center">
            ...
            <p class="font-14 font-weight-500 text-gray mt-30">
                <span class="d-block"><?php echo e(trans('update.this_course_requires_n_points',['points' => $course->points])); ?></span>
                <span class="d-block"><?php echo e(trans('update.you_have_n_points',['points' => $user->getRewardPoints()])); ?></span>

                <?php if($user->getRewardPoints() >= $course->points): ?>
        ...
        <div class="d-flex align-items-center mt-25">
            <a href="<?php echo e(($user->getRewardPoints() >= $course->points) ? '/course/'. $course->slug .'/points/apply' : '#'); ?>" class="btn btn-sm flex-grow-1 <?php echo e(($user->getRewardPoints() >= $course->points) ? 'btn-primary js-buy-course-with-point' : 'bg-gray300 text-gray disabled'); ?>"><?php echo e(trans('update.buy')); ?></a>
            <a href="/panel/rewards" class="btn btn-outline-primary ml-15 btn-sm flex-grow-1"><?php echo e(trans('update.my_points')); ?></a>
        </div>
    <?php endif; ?>
</div>
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/course/buy_with_point_modal.blade.php ENDPATH**/ ?>