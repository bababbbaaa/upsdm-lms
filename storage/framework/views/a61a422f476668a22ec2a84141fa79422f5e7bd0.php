...
<?php $__env->startSection('content'); ?>
    <div class="">
        ...
        <form method="post" action="/panel/webinars/<?php echo e(!empty($webinar) ? $webinar->id .'/update' : 'store'); ?>" id="webinarForm" class="webinar-form">
        ...
        <div class="create-webinar-footer d-flex flex-column flex-md-row align-items-center justify-content-between mt-20 pt-15 border-top">
            ...
            <div class="mt-20 mt-md-0">
                ...
                <?php if(!empty($webinar) and $webinar->creator_id == $authUser->id): ?>
                    <a href="/panel/webinars/<?php echo e($webinar->id); ?>/delete?redirect_to=/panel/webinars" class="delete-action webinar-actions btn btn-sm btn-danger mt-20 mt-md-0"><?php echo e(trans('public.delete')); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/panel/webinar/create.blade.php ENDPATH**/ ?>