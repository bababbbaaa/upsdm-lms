                ...
                <?php else: ?>
                    <span class="d-block font-14 text-gray font-weight-500">
                        ...
                        <?php if(!empty($meeting->amount) and $meeting->amount > 0): ?>
                            <?php if(!empty($meeting->discount)): ?>
                                <span class="text-decoration-line-through"><?php echo e(handlePrice($meeting->amount)); ?></span>
                                <span class="text-primary"><?php echo e(handlePrice($meeting->amount - (($meeting->amount * $meeting->discount) / 100))); ?></span>
                            <?php else: ?>
                                <span class="text-primary"><?php echo e(handlePrice($meeting->amount)); ?></span>
                            <?php endif; ?>
                        <?php else: ?>
                    ...
                    <span class="d-block font-14 text-gray font-weight-500">
                        ...
                        <?php if(!empty($meeting->in_person_amount) and $meeting->in_person_amount > 0): ?>
                            <?php if(!empty($meeting->discount)): ?>
                                <span class="text-decoration-line-through"><?php echo e(handlePrice($meeting->in_person_amount)); ?></span>
                                <span class="text-primary"><?php echo e(handlePrice($meeting->in_person_amount - (($meeting->in_person_amount * $meeting->discount) / 100))); ?></span>
                            <?php else: ?>
                                <span class="text-primary"><?php echo e(handlePrice($meeting->in_person_amount)); ?></span>
                            <?php endif; ?>
                        <?php else: ?>
                            <span class="text-primary"><?php echo e(trans('public.free')); ?></span>
                        <?php endif; ?>
                    ...
                    <?php if($meeting->group_meeting): ?>
                        ...
                        <div class="js-group-meeting-options d-none mt-15">
                            ...
                            <div class="js-online-group-amount d-none font-14 font-weight-500 mt-15">
                                <span class="text-gray d-block"><?php echo e(trans('update.online')); ?> <?php echo e(trans('update.group_meeting_hourly_rate_per_student',['amount' => addCurrencyToPrice($meeting->online_group_amount)])); ?></span>
                            ...
                            <div class="js-in-person-group-amount d-none font-14 font-weight-500 mt-15">
                                <span class="text-gray d-block"><?php echo e(trans('update.in_person')); ?> <?php echo e(trans('update.group_meeting_hourly_rate_per_student',['amount' => addCurrencyToPrice($meeting->in_person_group_amount)])); ?></span>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/user/profile_tabs/appointments.blade.php ENDPATH**/ ?>