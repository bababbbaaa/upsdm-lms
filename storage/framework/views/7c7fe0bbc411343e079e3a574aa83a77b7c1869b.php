                    ...
                    <div class="card">
                        <div class="card-header text-right">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_export_products')): ?>
                                <a href="/admin/store/products/excel?<?php echo e(!empty($inHouseProducts) ? 'in_house_products=true&' : ''); ?><?php echo e(http_build_query(request()->all())); ?>" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
                            <?php endif; ?>

                            <?php if(!empty($inHouseProducts)): ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_new_product')): ?>
                                    <a href="/admin/store/products/create?in_house_product=true" target="_blank" class="btn btn-primary ml-2"><?php echo e(trans('update.create_new_product')); ?></a>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                                ...
                                <table class="table table-striped font-14 ">
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <?php echo e(!empty($product->price) ? addCurrencyToPrice($product->price) : '-'); ?>

                                            </td>

                                            <td>
                                                <?php echo e($product->delivery_fee ? addCurrencyToPrice($product->delivery_fee) : '-'); ?>
                                            ...
                                            <td><?php echo e(addCurrencyToPrice($product->sales()->sum('total_amount'))); ?></td>
                                            ...
                                            <td width="120" class="btn-sm">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_edit_product')): ?>
                                                    <a href="/admin/store/products/<?php echo e($product->id); ?>/edit" target="_blank" class="btn-transparent btn-sm text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                <?php endif; ?>

                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_delete_product')): ?>
                                                    <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/store/products/'.$product->id.'/delete', 'btnClass' => 'btn-sm mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/store/products/lists.blade.php ENDPATH**/ ?>