                                    ...
                                    <li data-id="<?php echo e($section->id); ?>" class="form-group list-group">
                                        <div class="d-flex align-items-center justify-content-between p-2 border rounded-lg">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/settings/personalization/home_sections/'. $section->id .'/delete','btnClass' => 'text-danger mr-2 font-16'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/settings/personalization/home_sections.blade.php ENDPATH**/ ?>