                    ...
                    <div class="col-12 ">
                        <div class="table-responsive">
                            <table class="table text-center custom-table">
                                <thead>
                                <tr>
                                    <th><?php echo e(trans('product.course')); ?></th>
                                        ...
                                        <td class="align-middle font-weight-normal">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="/panel/certificates/webinars/<?php echo e($certificate->id); ?>/show" target="_blank" class="webinar-actions d-block"><?php echo e(trans('public.open')); ?></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/panel/certificates/webinar_certificates.blade.php ENDPATH**/ ?>