                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media-body">
                                            <div class=" mt-0 mb-1 font-weight-bold"><?php echo e(addCurrencyToPrice(handlePriceFormat($appointment->paid_amount))); ?></div>
                                        </div>
                                    </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/appointments/lists.blade.php ENDPATH**/ ?>