                ...
                <?php if(!empty($itemValue) and is_array($itemValue)): ?>
                    <?php $__currentLoopData = $itemValue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="/admin/settings/socials/<?php echo e($key); ?>/edit" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                    <i class="fa fa-edit"></i>
                                </a>

                                <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/settings/socials/'. $key .'/delete','btnClass' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </td>
                        </tr>
...
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/settings/general/socials.blade.php ENDPATH**/ ?>