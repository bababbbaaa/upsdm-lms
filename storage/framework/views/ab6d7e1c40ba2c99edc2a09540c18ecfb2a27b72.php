                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_quizzes_create')): ?>
                                <div class="text-right">
                                    <a href="/admin/quizzes/create" class="btn btn-primary ml-2"><?php echo e(trans('quiz.new_quiz')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/quizzes/lists.blade.php ENDPATH**/ ?>