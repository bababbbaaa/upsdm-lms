        ...
        <div class="create-webinar-footer d-flex flex-column flex-md-row align-items-center justify-content-between mt-20 pt-15 border-top">
            ...
            <div class="mt-20 mt-md-0">
                ...
                <?php if(!empty($product) and $product->creator_id == $authUser->id): ?>
                    <a href="/panel/store/products/<?php echo e($product->id); ?>/delete?redirect_to=/panel/store/products" class="delete-action webinar-actions btn btn-sm btn-danger mt-20 mt-md-0"><?php echo e(trans('public.delete')); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('web.default.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/panel/store/products/create.blade.php ENDPATH**/ ?>