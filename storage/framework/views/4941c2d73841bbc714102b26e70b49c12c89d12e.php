                    ...
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="text-primary font-weight-bold">
                                <?php echo e(addCurrencyToPrice($successOrders['amount'])); ?>
                    ...
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="text-success font-weight-bold">
                                <?php echo e(addCurrencyToPrice($canceledOrders['amount'])); ?>
                    ...
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="text-danger font-weight-bold">
                                <?php echo e(addCurrencyToPrice($waitingOrders['amount'])); ?>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="text-danger font-weight-bold">
                                <?php echo e(addCurrencyToPrice($totalOrders['amount'])); ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_products_orders_export')): ?>
                                <a href="/admin/store/orders/export?<?php echo e(!empty($inHouseOrders) ? 'in-house-orders=true&' : ''); ?><?php echo e(http_build_query(request()->all())); ?>" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
                            <?php endif; ?>
                        </div>
                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <?php echo e(!empty($order->buyer) ? $order->buyer->full_name : ''); ?>

                                                <div class="text-primary text-small font-600-bold">ID : <?php echo e(!empty($order->buyer) ? $order->buyer->id : ''); ?></div>
                                            </td>
                                            ...
                                            <td>
                                                <?php if(!empty($order->sale)): ?>
                                                    <span class=""><?php echo e(addCurrencyToPrice(handlePriceFormat($order->sale->total_amount))); ?></span>
                                                <?php endif; ?>
                                            </td>

                                            <td>
                                                <?php if(!empty($order->sale)): ?>
                                                    <span class=""><?php echo e(addCurrencyToPrice(handlePriceFormat($order->sale->discount))); ?></span>
                                                <?php endif; ?>
                                            </td>

                                            <td>
                                                <?php if(!empty($order->sale)): ?>
                                                    <span class=""><?php echo e(addCurrencyToPrice(handlePriceFormat($order->sale->tax))); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_products_orders_invoice')): ?>
                                                    <?php if(!empty($order->product)): ?>
                                                        <a href="/admin/store/orders/<?php echo e($order->id); ?>/invoice" target="_blank" title="<?php echo e(trans('admin/main.invoice')); ?>"><i class="fa fa-print" aria-hidden="true"></i></a>
                                                    <?php endif; ?>
                                                <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/store/orders/lists.blade.php ENDPATH**/ ?>