                        ...
                        <?php if(!empty($getNetProfitStatistics)): ?>
                            <div class="statistic-details mt-4 position-relative">
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value"><?php echo e(addCurrencyToPrice($getNetProfitStatistics['todayIncome']['amount'])); ?></div>
                                ...
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value"><?php echo e(addCurrencyToPrice($getNetProfitStatistics['weekIncome']['amount'])); ?></div>
                                ...
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value"><?php echo e(addCurrencyToPrice($getNetProfitStatistics['monthIncome']['amount'])); ?></div>
                                ...
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value"><?php echo e(addCurrencyToPrice($getNetProfitStatistics['yearIncome']['amount'])); ?></div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="/admin/webinars?type=course&sort=sales_desc" class="btn btn-primary"><?php echo e(trans('admin/main.view_more')); ?><i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped font-14">
                                ...
                                <?php $__currentLoopData = $getTopSellingClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getTopSellingClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(addCurrencyToPrice($getTopSellingClass->sales_amount)); ?></td>
                                    </tr>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="/admin/consultants?sort=appointments_desc" class="btn btn-sm btn-primary"><?php echo e(trans('admin/main.view_more')); ?><i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive text-center">
                            <table class="table table-striped font-14">
                                ...
                                <?php $__currentLoopData = $getTopSellingAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getTopSellingAppointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(addCurrencyToPrice($getTopSellingAppointment->sales_amount)); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </table>
                        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="/admin/instructors?sort=sales_classes_desc" class="btn btn-sm btn-primary"><?php echo e(trans('admin/main.view_more')); ?><i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive text-center">
                            <table class="table table-striped font-14">
                                ...
                                <?php $__currentLoopData = $getTopSellingTeachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getTopSellingTeacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(addCurrencyToPrice($getTopSellingTeacher->sales_amount)); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </table>
                        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="/admin/organizations?sort=sales_classes_desc" class="btn btn-sm btn-primary"><?php echo e(trans('admin/main.view_more')); ?><i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive text-center">
                            <table class="table table-striped font-14">
                                ...
                                <?php $__currentLoopData = $getTopSellingOrganizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getTopSellingOrganization): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(addCurrencyToPrice($getTopSellingOrganization->sales_amount)); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </table>
                        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="/admin/students?sort=register_desc" class="btn btn-sm btn-primary"><?php echo e(trans('admin/main.view_more')); ?><i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive text-center">
                            <table class="table table-striped font-14">
                                ...
                                <?php $__currentLoopData = $getMostActiveStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getMostActiveStudent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(addCurrencyToPrice($getMostActiveStudent->total_cost)); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </table>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/marketing_dashboard.blade.php ENDPATH**/ ?>