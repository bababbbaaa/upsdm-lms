    ...
    <div class="d-flex align-items-center justify-content-between " role="tab" id="quiz_<?php echo e(!empty($quizInfo) ? $quizInfo->id :'record'); ?>">
        ...
        <div class="d-flex align-items-center">
            ...
            <?php if(!empty($quizInfo)): ?>
                <a href="/admin/quizzes/<?php echo e($quizInfo->id); ?>/delete" class="delete-action btn btn-sm btn-transparent text-gray">
...
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/webinars/create_includes/accordions/quiz.blade.php ENDPATH**/ ?>