                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_quick_access_links')): ?>
                                <div>
                                    ...
                                    <div class="mt-2 mb-2 d-flex flex-column flex-md-row">
                                        <a href="/admin/comments/webinars" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="far fa-comment"></i><?php echo e(trans('admin/main.comments')); ?> </a>
                                        <a href="/admin/supports" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="far fa-envelope"></i><?php echo e(trans('admin/main.tickets')); ?></a>
                                        <a href="/admin/reports/webinars" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="fas fa-info"></i><?php echo e(trans('admin/main.reports')); ?></a>
                                    </div>
                                </div>
                            <?php endif; ?>
                    ...
                    <?php if(!empty($getIncomeStatistics)): ?>
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                ...
                                <div class="card-stats-items">
                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e(addCurrencyToPrice($getIncomeStatistics['todaySales'])); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('admin/main.today')); ?></div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e(addCurrencyToPrice($getIncomeStatistics['monthSales'])); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('admin/main.this_month')); ?></div>
                                    </div>

                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e(addCurrencyToPrice($getIncomeStatistics['yearSales'])); ?></div>
                            ...
                            <div class="card-wrap">
                                ...
                                <div class="card-body">
                                    <?php echo e(addCurrencyToPrice($getIncomeStatistics['totalSales'])); ?>
                                    ...
                                    <?php if(!empty($getMonthAndYearSalesChartStatistics)): ?>
                                        <div class="statistic-details mt-4 position-relative">
                                            <div class="statistic-details-item">
                                                ...
                                                <div class="detail-value"><?php echo e(addCurrencyToPrice($getMonthAndYearSalesChartStatistics['todaySales']['amount'])); ?></div>
                                            ...
                                            <div class="statistic-details-item">
                                                ...
                                                <div class="detail-value"><?php echo e(addCurrencyToPrice($getMonthAndYearSalesChartStatistics['weekSales']['amount'])); ?></div>
                                            ...
                                            <div class="statistic-details-item">
                                                ...
                                                <div class="detail-value"><?php echo e(addCurrencyToPrice($getMonthAndYearSalesChartStatistics['monthSales']['amount'])); ?></div>
                                            ...
                                            <div class="statistic-details-item">
                                                ...
                                                <div class="detail-value"><?php echo e(addCurrencyToPrice($getMonthAndYearSalesChartStatistics['yearSales']['amount'])); ?></div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>