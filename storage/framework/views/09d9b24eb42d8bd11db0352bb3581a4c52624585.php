                                ...
                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <span><?php echo e(addCurrencyToPrice(handlePriceFormat($order->sale->amount))); ?></span>
                                        </td>
                                        <td class="align-middle"><?php echo e(addCurrencyToPrice(handlePriceFormat($order->sale->discount) ?? 0)); ?></td>
                                        <td class="align-middle">
                                            <span><?php echo e(addCurrencyToPrice(handlePriceFormat($order->sale->total_amount))); ?></span>
                                        </td>
                                        <td class="align-middle">
                                            <span><?php echo e(addCurrencyToPrice(handlePriceFormat($order->sale->getIncomeItem()))); ?></span>
                                        </td>
                                        <td class="align-middle">
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/panel/store/sales.blade.php ENDPATH**/ ?>