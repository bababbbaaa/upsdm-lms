        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    <a href="/admin/bundles"><?php echo e(trans('update.bundles')); ?></a>
                </div>
                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="/admin/bundles/<?php echo e(!empty($bundle) ? $bundle->id.'/update' : 'store'); ?>" id="webinarForm" class="webinar-form">
                                                            ...
                                                            <?php $__currentLoopData = $bundleWebinars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bundleWebinar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if(!empty($bundleWebinar->webinar->title)): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo e(addCurrencyToPrice(handlePriceFormat($bundleWebinar->webinar->price))); ?></td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/bundle-webinars/'. $bundleWebinar->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                        </td>
                                                                    </tr>
                                                                <?php endif; ?>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/bundles/create.blade.php ENDPATH**/ ?>