                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_edit')): ?>
                                                    <a href="/admin/users/<?php echo e($become->user_id); ?>/edit?type=check_instructor_request" class="btn-transparent text-primary mr-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.check')); ?>">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_become_instructors_reject')): ?>
                                                    <?php if($become->status != 'accept'): ?>
                                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/users/become-instructors/'. $become->id .'/reject' , 'btnClass' => 'mr-1', 'btnIcon' => 'fa-check','tooltip' => trans('admin/main.reject_request')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    <?php endif; ?>
                                                <?php endif; ?>

                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_become_instructors_delete')): ?>
                                                    <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/users/become-instructors/'. $become->id .'/delete' , 'btnClass' => '','tooltip' => trans('admin/main.delete')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/users/become_instructors/lists.blade.php ENDPATH**/ ?>