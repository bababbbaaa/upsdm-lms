            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e(!empty($physicalSales) ? addCurrencyToPrice($physicalSales) : 0); ?></strong>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5"><?php echo e(!empty($virtualSales) ? addCurrencyToPrice($virtualSales) : 0); ?></strong>
                                        ...
                                        <div class="btn-group dropdown table-actions">
                                            ...
                                            <div class="dropdown-menu ">
                                                ...
                                                <?php if($product->creator_id == $authUser->id): ?>
                                                    <a href="/panel/store/products/<?php echo e($product->id); ?>/delete" class="webinar-actions d-block mt-10 text-danger delete-action"><?php echo e(trans('public.delete')); ?></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                ...
                                <div class="webinar-price-box mt-15">
                                    <?php if($product->price > 0): ?>
                                        <?php if($product->getPriceWithActiveDiscountPrice() < $product->price): ?>
                                            <span class="real"><?php echo e(handlePrice($product->getPriceWithActiveDiscountPrice())); ?></span>
                                            <span class="off ml-10"><?php echo e(handlePrice($product->price)); ?></span>
                                        <?php else: ?>
                                            <span class="real"><?php echo e(handlePrice($product->price)); ?></span>
                                        <?php endif; ?>
                                    <?php else: ?>
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        ...
                                        <?php if(!empty($product->sales()) and count($product->sales())): ?>
                                            <span class="stat-value"><?php echo e($product->salesCount()); ?> (<?php echo e(addCurrencyToPrice($product->sales()->sum('total_amount'))); ?>)</span>
                                        <?php else: ?>
                                    ...
                                    <?php if($product->isPhysical()): ?>
                                        <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                            ...
                                            <span class="stat-value"><?php echo e(!empty($product->delivery_fee) ? addCurrencyToPrice($product->delivery_fee) : 0); ?></span>
                                        </div>
...
<?php echo $__env->make('web.default.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/panel/store/products/lists.blade.php ENDPATH**/ ?>