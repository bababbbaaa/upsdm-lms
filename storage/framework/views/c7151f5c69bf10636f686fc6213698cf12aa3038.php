...
<head>
    ...
    <title><?php echo e($generalSettings['site_name']); ?></title>
   <?php else: ?>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                                <tr>
                                    <td class="headerContent" width="100%">
                                        <a href=""><img src="<?php echo e(url($generalSettings['logo'])); ?>" style="max-width:128px;margin-bottom: 8px;margin-top: 24px" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowtext/></a>
                                    </td>
                                </tr>
                            </table>
                            <!-- // END PREHEADER -->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                <tr>
                                    <td valign="top" class="footerContent" style="padding-top:0; padding-bottom:40px;" mc:edit="footer_content02">
                                        <?php echo $__env->yieldContent('cancel'); ?>
                                    </td>
                                </tr>
...
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/layouts/email.blade.php ENDPATH**/ ?>