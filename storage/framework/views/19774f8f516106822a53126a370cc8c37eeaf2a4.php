    ...
    <div class="row">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_enrollment_add_student_to_items')): ?>
            <div class="col-12 col-md-6">
                <h5 class="section-title after-line"><?php echo e(trans('admin/main.add_a_course_to_the_student')); ?></h5>
...
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/users/editTabs/purchased_courses.blade.php ENDPATH**/ ?>