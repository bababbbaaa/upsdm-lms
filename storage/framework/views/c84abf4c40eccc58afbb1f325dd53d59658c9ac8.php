                    ...
                    <div class="no-result default-no-result mt-50 d-flex align-items-center justify-content-center flex-column">
                        ...
                        <div class="d-flex align-items-center flex-column mt-30 text-center">
                            ...
                            <div class=" mt-25">
                                ...
                                <?php if($quiz->certificate): ?>
                                    <a href="/panel/quizzes/results/<?php echo e($quizResult->id); ?>/showCertificate" class="btn btn-sm btn-primary"><?php echo e(trans('quiz.download_certificate')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/panel/quizzes/status.blade.php ENDPATH**/ ?>