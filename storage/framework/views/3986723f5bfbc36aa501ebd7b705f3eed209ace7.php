    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-9 d-block d-md-flex align-items-center justify-content-start my-25 my-lg-0">
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center mx-0 mx-md-20 my-20 my-md-0">
                <label class="mb-0 mr-10 cursor-pointer" for="free_shipping"><?php echo e(trans('update.free_shipping')); ?></label>
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="free_shipping" class="custom-control-input" id="free_shipping" <?php if(request()->get('free_shipping', null) == 'on'): ?> checked="checked" <?php endif; ?>>
...
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/products/includes/top_filters.blade.php ENDPATH**/ ?>