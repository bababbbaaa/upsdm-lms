        ...
        <div class="row">
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(trans('admin/main.total_organizations')); ?></h4>
                        </div>
                        <div class="card-body">
                            <?php echo e($totalOrganizations); ?>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4><?php echo e(trans('admin/main.verified_organizations')); ?></h4>
                        </div>
                        <div class="card-body">
                            <?php echo e($verifiedOrganizations); ?>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        ...
                        <div class="card-body">
                            <?php echo e($totalOrganizationsTeachers); ?>
    ...
    <div class="card">
        <div class="card-header">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_export_excel')): ?>
                <a href="/admin/organizations/excel?<?php echo e(http_build_query(request()->all())); ?>" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
            <?php endif; ?>
            <div class="h-10"></div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="media-body">
                                    ...
                                    <div class="text-small font-600-bold"><?php echo e(addCurrencyToPrice(handlePriceFormat($user->classesSalesSum))); ?></div>
                                </div>
                            </td>
                            <td>
                                <div class="media-body">
                                    <div class="text-primary mt-0 mb-1 font-weight-bold"><?php echo e($user->meetingsSalesCount); ?></div>
                                    <div class="text-small font-600-bold"><?php echo e(addCurrencyToPrice(handlePriceFormat($user->meetingsSalesSum))); ?></div>
                                </div>
                            </td>
                            <td>
                                <div class="media-body">
                                    <div class="text-primary mt-0 mb-1 font-weight-bold"><?php echo e($user->classesPurchasedsCount); ?></div>
                                    <div class="text-small font-600-bold"><?php echo e(addCurrencyToPrice(handlePriceFormat($user->classesPurchasedsSum))); ?></div>
                                </div>
                            </td>
                            <td>
                                <div class="media-body">
                                    <div class="text-primary mt-0 mb-1 font-weight-bold"><?php echo e($user->meetingsPurchasedsCount); ?></div>
                                    <div class="text-small font-600-bold"><?php echo e(addCurrencyToPrice(handlePriceFormat($user->meetingsPurchasedsSum))); ?></div>
                                </div>
                            </td>
                            <td class="text-primary mt-0 mb-1 font-weight-bold"><?php echo e($user->getOrganizationTeachers()->count()); ?></td>
                            <td class="text-primary mt-0 mb-1 font-weight-bold"><?php echo e($user->getOrganizationStudents()->count()); ?></td>
                            ...
                            <td>
                                <div class="media-body">
                                    <?php if($user->ban and !empty($user->ban_end_at) and $user->ban_end_at > time()): ?>
                                        ...
                                        <div class="text-small font-600-bold">Until <?php echo e(dateTimeFormat($user->ban_end_at, 'j M Y')); ?></div>
                                    <?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/users/organizations.blade.php ENDPATH**/ ?>