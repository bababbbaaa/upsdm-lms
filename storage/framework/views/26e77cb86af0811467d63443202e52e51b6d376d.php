                    ...
                    <div class="col-lg-6">
                        <div class="card card-large-icons">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/admin/settings/personalization/page_background" class="card-cta"><?php echo e(trans('admin/main.change_setting')); ?><i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>