<div class="d-none" id="exchangePointsModal">
    ...
    <div class="text-center">
        ...
        <p class="font-14 font-weight-500 text-gray mt-30">
            <span class="d-block"><?php echo e(trans('update.you_will_get_n_for_points',['amount' => addCurrencyToPrice($earnByExchange) ,'points' => $availablePoints])); ?></span>
...
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/panel/rewards/exchange_modal.blade.php ENDPATH**/ ?>