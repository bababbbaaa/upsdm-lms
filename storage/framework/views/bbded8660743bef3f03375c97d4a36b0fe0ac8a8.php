<div class="tab-pane mt-3 fade" id="badges" role="tabpanel" aria-labelledby="badges-tab">
    <div class="row">
        ...
        <h5 class="section-title after-line"><?php echo e(trans('admin/main.add_a_custom_badge_to_the_student')); ?></h5>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class=" mt-4">
                    <button class="btn btn-primary"><?php echo e(trans('admin/main.add')); ?></button>
                </div>
            </form>
...
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/users/editTabs/badges.blade.php ENDPATH**/ ?>