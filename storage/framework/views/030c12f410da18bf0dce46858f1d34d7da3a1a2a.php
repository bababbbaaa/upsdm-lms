            ...
            <form action="/admin/settings/main" method="post">
                ...
                <?php
                    $pages = ['admin_login','admin_dashboard', 'login','register','remember_pass','verification',
                        ...
                        'organizations','dashboard','user_avatar','user_cover','instructor_finder_wizard','products_lists'
                    ];
                ?>
...
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/settings/personalization/page_background.blade.php ENDPATH**/ ?>