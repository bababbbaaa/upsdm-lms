                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="productForm" method="post" action="/admin/store/products/<?php echo e(!empty($product) ? $product->id.'/update' : 'store'); ?>" class="webinar-form">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/admin/store/products/create.blade.php ENDPATH**/ ?>