            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <select name="ajax[new][session_api]" class="js-ajax-session_api form-control">
                        <option value="local"><?php echo e(trans('webinars.session_local_api')); ?></option>
                        <option value="big_blue_button"><?php echo e(trans('webinars.session_big_blue_button')); ?></option>
                        <option value="zoom"><?php echo e(trans('webinars.session_zoom')); ?></option>
                        <option value="agora"><?php echo e(trans('update.agora')); ?></option>
                    </select>
                    <div class="invalid-feedback"></div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\fresh-lms\resources\views/web/default/panel/webinar/make_next_session_modal.blade.php ENDPATH**/ ?>